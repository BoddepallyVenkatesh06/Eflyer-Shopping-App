...
const SocialIcon = ({ Icon, url }) => {
    return (
        <a href={url} target='__blank'>
            <li className='w-[50px] h-[50px] rounded-full bg-black flex items-center justify-center cursor-pointer duration-300 hover:text-[#da2f68] shadow-on-hoverIcon'  >
                <Icon alt={`Icon`} />
            </li>
        </a>
    )
...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#3a4042] py-[50px] text-white relative ">
            <ContentWrapper className='flex flex-col items-center'>

                <ul className="list-none flex items-center justify-center gap-4 md:gap-[30px] mb-5 md:mb-[30px] ">
                    <li className="cursor-pointer text-xs md:text-base hover:text-[#da2f68] duration-200">Terms Of Use</li>
                    <li className="cursor-pointer text-xs md:text-base hover:text-[#da2f68] duration-200">Privacy-Policy</li>
                    <li className="cursor-pointer text-xs md:text-base hover:text-[#da2f68] duration-200">About</li>
                    <li className="cursor-pointer text-xs md:text-base hover:text-[#da2f68] duration-200">Blog</li>
                    <li className="cursor-pointer text-xs md:text-base hover:text-[#da2f68] duration-200">FAQ</li>
                </ul>
